...
internal class OutputMessageTemplateSelector : DataTemplateSelector
{
    ...
    public DataTemplate RecognizedTextMessageTemplate { get; set; }
    public DataTemplate TranslatedTextMessageTemplate { get; set; }
    ...
    protected override DataTemplate OnSelectTemplate(object item, BindableObject container)
    {
        ...
        return type switch
        {
            ...
            OutputMessageType.RecognizedText => RecognizedTextMessageTemplate,
            OutputMessageType.TranslatedText => TranslatedTextMessageTemplate,
